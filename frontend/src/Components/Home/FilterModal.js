...
const FilterModal = ({selectedFilters, onFilterChange, onClose }) => {
  ...
  const [propertyType, setPropertyType] = useState(
    selectedFilters.propertyType || '' //default it is empty or the selected property type from prop
  );
  ...
  //functiom to handle changes in amenities
  ...
  //function to handle changes in propTypes
      ...
      <div className='modal-filters-container'>
        ...
        <div className='filter-section'>
          ...
          <div className='icon-box'>
            {propertyTypeOptions.map((options) => ( //map is used to iterate.
              <div 
                key={options.value}
        ...
        <div className='filter-section'>
          ...
          <div className='icon-box'>
            {roomTypeOptions.map((options) => ( //map is used to iterate.
              <div 
                key={options.value}
                className={`selectable-box ${
        ...
        <div className='filter-section'>
          ...
          <div className='amenities-checkbox'>
            {amenitiesOptions.map((options) => ( //map is used to iterate.
              <div 
                key={options.value}
